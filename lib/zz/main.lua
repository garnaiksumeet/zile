...
--
-- Options which take no argument have an optional_argument, so that no
-- argument is signalled as extraneous.
  ...
  for c, optarg, optind, longindex in posix.getopt (arg, "-:f:l:q", longopts) do
    ...
    elseif longindex == 4 then
      io.write ("Usage: " .. arg[0] .. " [OPTION-OR-FILENAME]...\n" ..
                "\n" ..
                "Run " .. prog.Name .. ", a lightweight text editor.\n" ..
                "\n")
...
function main ()
  ...
  -- error.
  if #zarg == 0 and not minibuf_contents and not eval.get_variable_bool ("inhibit_splash_screen") then
